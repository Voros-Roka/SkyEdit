...
export class EoS_ShopItem extends DataMapping
{
	#view = null;
	...
	constructor(view)
	{
		...
		/*console.log(i18n`Parsing EoS Savefile Slot Shop Item`);
	...
	get quantity()
	{
		return this.#view.getUint16(0x0000000B,true,0x0000000B);
	}

	set quantity(value)
	{
		this.#view.setUint16(0x0000000B,value,true,0x0000000B);
	}
}