...
export class EoS_AssemblyMember extends DataMapping
{
	#view = null;
	#moves = [];
	...
	constructor(view)
	{
		...
		/*console.log(i18n`Parsing EoS Savefile Slot Assembly Member`);
		console.log(i18n`isvalid is '${this.isvalid.toString()}'`);
	...
	set isvalid(value)
	{
		this.#view.setUint8(0x00000000,value);
	}

	get level()
	{
		return this.#view.getUint8(0x00000001,0x00000007);
	}

	set level(value)
	{
		this.#view.setUint8(0x00000001,value,0x00000007);
	}
	...
	get joinedfloor()
	{
		return this.#view.getUint8(0x0000001B,0x00000008);
	}

	set joinedfloor(value)
	{
		this.#view.setUint8(0x0000001B,value,0x00000008);
	}

	get lvlat1stevo()
	{
		return this.#view.getUint8(0x00000023,0x00000007);
	}

	set lvlat1stevo(value)
	{
		this.#view.setUint8(0x00000023,value,0x00000007);
	}

	get lvlat2ndevo()
	{
		return this.#view.getUint8(0x0000002A,0x00000007);
	}

	set lvlat2ndevo(value)
	{
		this.#view.setUint8(0x0000002A,value,0x00000007);
	}

	get iq()
	{
		return this.#view.getUint16(0x00000031,true,0x0000000A);
	}

	set iq(value)
	{
		this.#view.setUint16(0x00000031,value,true,0x0000000A);
	}

	get hp()
	{
		return this.#view.getUint16(0x0000003B,true,0x0000000A);
	}

	set hp(value)
	{
		this.#view.setUint16(0x0000003B,value,true,0x0000000A);
	}

	get atk()
	{
		return this.#view.getUint8(0x00000045,0x00000008);
	}

	set atk(value)
	{
		this.#view.setUint8(0x00000045,value,0x00000008);
	}

	get spatk()
	{
		return this.#view.getUint8(0x0000004D,0x00000008);
	}

	set spatk(value)
	{
		this.#view.setUint8(0x0000004D,value,0x00000008);
	}

	get def()
	{
		return this.#view.getUint8(0x00000055,0x00000008);
	}

	set def(value)
	{
		this.#view.setUint8(0x00000055,value,0x00000008);
	}

	get spdef()
	{
		return this.#view.getUint8(0x0000005D,0x00000008);
	}

	set spdef(value)
	{
		this.#view.setUint8(0x0000005D,value,0x00000008);
	}

	get exp()
	{
		return this.#view.getUint32(0x00000065,true,0x00000018);
	}

	set exp(value)
	{
		this.#view.setUint32(0x00000065,value,true,0x00000018);
	}

	get iqflags()
	{
		return this.#view.getBoolArray(0x0000007D,0x00000045);
	}
	...
	get tactic()
	{
		return this.#view.getUint8(0x000000C2,0x00000004);
	}

	set tactic(value)
	{
		this.#view.setUint8(0x000000C2,value,0x00000004);
	}
	...
	get name()
	{
		return this.#view.getString("utf-8",0x0000011A,10);
	}

	set name(value)
	{
		this.#view.setString("utf-8",0x0000011A,value,10,true);
	}
